; ModuleID = 'playground.9lfopudc-cgu.0'
source_filename = "playground.9lfopudc-cgu.0"
...
@vtable.0 = private unnamed_addr constant { void (i8**)*, i64, i64, i32 (i8**)*, i32 (i8**)*, i32 (i8**)* } { void (i8**)* @_ZN4core3ptr18real_drop_in_place17he87a25b8b3c948a3E, i64 8, i64 8, i32 (i8**)* @"_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17h6ea8ca667255d182E", i32 (i8**)* @"_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17h6ea8ca667255d182E", i32 (i8**)* @"_ZN4core3ops8function6FnOnce40call_once$u7b$$u7b$vtable.shim$u7d$$u7d$17h99944c8692991633E" }, align 8
...
@6 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [11 x i8] }>, <{ [11 x i8] }>* @5, i32 0, i32 0, i32 0), [16 x i8] c"\0B\00\00\00\00\00\00\00\12\00\00\00\05\00\00\00" }>, align 8

; std::rt::lang_start
; Function Attrs: nonlazybind uwtable
define hidden i64 @_ZN3std2rt10lang_start17h1c7aa54682d7fb74E(void ()* nonnull %main, i64 %argc, i8** %argv) unnamed_addr #0 {
start:
...
; Function Attrs: nonlazybind uwtable
define internal i32 @"_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17h6ea8ca667255d182E"(i8** noalias nocapture readonly align 8 dereferenceable(8) %_1) unnamed_addr #0 {
start:
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h9eb0e5607d141234E"(i8** noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter"* align 8 dereferenceable(96) %f) unnamed_addr #0 {
start:
...
; Function Attrs: nonlazybind uwtable
define internal i32 @"_ZN4core3ops8function6FnOnce40call_once$u7b$$u7b$vtable.shim$u7d$$u7d$17h99944c8692991633E"(i8** nocapture readonly %_1) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception"*, %"unwind::libunwind::_Unwind_Context"*)* @rust_eh_personality {
start:
  %0 = bitcast i8** %_1 to void ()**
  %1 = load void ()*, void ()** %0, align 8, !nonnull !2
...
define internal void @_ZN4core3ptr18real_drop_in_place17he87a25b8b3c948a3E(i8** nocapture align 8 dereferenceable(8) %_1) unnamed_addr #1 {
start:
  ret void
}
...
define internal fastcc i8 @_ZN10playground6helper17h13959b2fcaa7ab52E(i8* noalias align 1 dereferenceable(1), i8*) unnamed_addr #2 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception"*, %"unwind::libunwind::_Unwind_Context"*)* @rust_eh_personality {
bb8:
...
; playground::main
; Function Attrs: nonlazybind uwtable
define internal void @_ZN10playground4main17hd4d800f638200e60E() unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception"*, %"unwind::libunwind::_Unwind_Context"*)* @rust_eh_personality {
start:
  ...
  %1 = icmp eq i8* %0, null
  br i1 %1, label %bb6.i.i, label %"_ZN5alloc5boxed12Box$LT$T$GT$3new17hbe95938fc921ebf3E.exit"
...
"_ZN5alloc5boxed12Box$LT$T$GT$3new17hbe95938fc921ebf3E.exit": ; preds = %start
  store i8 25, i8* %0, align 1
  call void @llvm.lifetime.start.p0i8(i64 1, i8* nonnull %res)
; call playground::helper
  %2 = tail call fastcc i8 @_ZN10playground6helper17h13959b2fcaa7ab52E(i8* noalias nonnull align 1 dereferenceable(1) %0, i8* nonnull %0)
  store i8 %2, i8* %res, align 1
  %3 = icmp eq i8 %2, 20
  br i1 %3, label %bb5, label %bb6

bb5:                                              ; preds = %"_ZN5alloc5boxed12Box$LT$T$GT$3new17hbe95938fc921ebf3E.exit"
  call void @llvm.lifetime.end.p0i8(i64 1, i8* nonnull %res)
  ret void

bb6:                                              ; preds = %"_ZN5alloc5boxed12Box$LT$T$GT$3new17hbe95938fc921ebf3E.exit"
  ...
  store i8* bitcast (i1 (i8**, %"core::fmt::Formatter"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h9eb0e5607d141234E" to i8*), i8** %9, align 8
  ...
  store i8* bitcast (i1 (i8**, %"core::fmt::Formatter"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h9eb0e5607d141234E" to i8*), i8** %12, align 8
...
top:
  ...
  store void ()* @_ZN10playground4main17hd4d800f638200e60E, void ()** %4, align 8
...
!6 = !{!7}
!7 = distinct !{!7, !8, !"_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17h6ea8ca667255d182E: %_1"}
!8 = distinct !{!8, !"_ZN3std2rt10lang_start28_$u7b$$u7b$closure$u7d$$u7d$17h6ea8ca667255d182E"}
!9 = !{!10}
